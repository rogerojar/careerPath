...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <div id="myGallery">
      <img class="masthead-avatar mb-5" src="assets/images/clipart/IT.png" alt="" class="active" id="result">

</div>
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0" id="title_text"></h1>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0" id="other_text"></p>
  ...
  <div class="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-labelledby="portfolioModal3Label" aria-hidden="true">
    ...
    <script>
           ...
           $("#result").attr("src", "assets/images/icon/loader2.gif");
          ...
          getData=function(){
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: 'profilePageResult.php',
                    data: {o : getUrlParameter('email')
                    },
              ...
              function showBucket(score){
                 if(score >= 20){
                      $("#result").attr("src", "assets/images/clipart/compsci.png");
                      //fix text
                      $("#title_text").text("B.Sc. Computer Science");
                      $("#other_text").text("This Undergraduate degree may be worth pursing since you show interest in development.");
                    }else if(score >= 13){

                      $("#result").attr("src", "assets/images/clipart/IT.png");
                      $("#title_text").text("B.Sc. Information Technology");
                      $("#other_text").text("This Undergraduate degree may be worth checking out since you show an interest in many different areas of computing.");
                    
                    }else{

                      $("#result").attr("src", "assets/images/clipart/sorry.png");
                      $("#title_text").text("sorry :(");
                      $("#other_text").text("Unfortunately we cannot reccommend any of the programmes in out database but when we update please return and take another quiz.");
               ...
               getData();
                ...
                //function to get score and display correct bucket image and text! parameter score
